...
if($like_status==1) {
 ...
 //echo $logoutUrl; 
	...
	echo "<img border=0 src=\"http://hollistercarwash.com/wp-content/themes/twentyeleven/images/banner9.jpg\"><br/><h3>Bring this QR Code Coupon at our center ...REDEEM and obtain discount!</h3>";
...
?>
 ...
 <tr>
 <td valign="top">
    <img src="http://chart.apis.google.com/chart?cht=qr&chl=http://apps.brandlocato.com/qdiscount/index.php?id=<?php echo $id; ?>%26coupon=FAC&chs=220x220"
alt="Redeem" />
</td><td valign="middle"> 
...
echo "<h3>Like a discount on your car wash ? Like Us to get a free discount coupon!</h3>";
